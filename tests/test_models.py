...
class TestLogEntry:
    ...
    def test_default_log_entry(self):
        ...
        entry = LogEntry(project_name="test_project", run_id=uuid4())
    ...
    def test_level_validation(self):
        ...
        for level in valid_levels:
            entry = LogEntry(project_name="test_project", run_id=uuid4(), level=level)
            assert entry.level == level

        # Invalid level should raise validation error
        with pytest.raises(ValueError):
            LogEntry(project_name="test_project", run_id=uuid4(), level="INVALID")
    ...
    def test_context_validation_dict(self):
        ...
        entry = LogEntry(
            project_name="test_project", run_id=uuid4(), context=context_dict
        )
    ...
    def test_context_validation_json_string(self):
        ...
        entry = LogEntry(
            project_name="test_project", run_id=uuid4(), context=json_string
        )
    ...
    def test_context_validation_invalid_json(self):
        ...
        entry = LogEntry(
            project_name="test_project", run_id=uuid4(), context=invalid_json
        )
    ...
    def test_context_validation_empty(self):
        ...
        entry = LogEntry(project_name="test_project", run_id=uuid4(), context=None)
        assert entry.context == {}

        # Empty string should become empty dict
        entry = LogEntry(project_name="test_project", run_id=uuid4(), context="")
        assert entry.context == {}
